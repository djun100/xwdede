...
E_D("replace into `phome_enewsmemberf` values('4','call','联系电话','text','<input name=\\\\\"call\\\\\" type=\\\\\"text\\\\\" id=\\\\\"call\\\\\" value=\\\\\"<?=\$ecmsfirstpost==1?\\\\\"\\\\\":htmlspecialchars(stripSlashes(\$addr[call]))?>\\\\\">\r\n','','2','VARCHAR','30','','');");
