...
<div id="innerContenter">
	<div class="width960 mainContent">
		<div class="head">
			<div class="topTitle t1"></div>
			<div class="breadcom">
				<span class="t">当前位置：</span>[!--newsnav--]
</div>
		</div>
		<div class="content">
...
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('selfinfo',10,0,0,'','id asc');
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
...
{
?>
<li><a class="sLink active" title="<?=$bqr[title]?>" href="<?=$bqsr[titleurl]?>"><span class="f left"></span><span class="left"><?=$bqr[title]?></span><span class="ta right"></span></a>
<div class="clear"></div>
</li>
<?
}
...
{
?>
<li><a class="sLink " title="<?=$bqr[title]?>" href="<?=$bqsr[titleurl]?>">
<span class="f left"></span><span class="left"><?=$bqr[title]?></span><span class="ta right"></span></a>
<div class="clear"></div>
</li>
<?
}
...
<?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select classimg from phome_enewsclass where classid='$GLOBALS[navclassid]'",1,24,0);
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
?>
<div class="banner" style="background: url('<?=$bqr['classimg']?>') no-repeat"></div>
<?php
}
?> 
				...
				<div id="contentersO1">
																<h1><span style="line-height: 200%"><span style="color: rgb(51,51,51)"><span style="background-color: rgb(255,255,255)"><span style="font-size: 16px"><span style="font-family: 微软雅黑">[!--title--]</span></span><span style="font-family: 微软雅黑"> </span></span></span><span style="font-size: 13px"><span style="font-family: 微软雅黑"><span style="color: rgb(255,102,0)"><br />
</span></span></span></span></h1>
<!-- TianJi Button BEGIN -->
<div id="ckepop">
<a href="http://tj.see-say.com/share.asp" class="tianji tianji_txt jtico jtico_tianji" target="_blank">分享到：</a>
<a title="分享到新浪微博" class="tianji_button_tsina">新浪微博</a>
<a title="分享到QQ空间" class="tianji_button_qzone">QQ空间</a>
<a title="分享到开心网" class="tianji_button_kaixin001">开心网</a>
<a title="分享到人人网" class="tianji_button_renren">人人网</a>
</div>
<script type="text/javascript" src="http://tj.see-say.com/code/jia.js" charset="utf-8"></script>
<!-- TianJi Button END -->
 <br />
[!--newstext--]
<p align="center" class="pageLink">[!--page.url--]</p>								</div>
							</div>
			<div class="clear"></div>
