...
$phome_db_username='zhxwd888';	//数据库用户名
$phome_db_password='n5h5b4m7';	//数据库密码
$phome_db_dbname='zhxwd888';	//数据库名
...
//后台安全设置
$do_loginauth='2008';	//登录认证码,如果设置登录需要输入此认证码才能通过
$do_ecookiernd='nbfz7YX7X826wXKVLp39g6wLSXNZjg';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$phome_cookievarpre='mjwxj';		//前台cookie变量前缀
$phome_cookieadminvarpre='enksx';		//后台cookie变量前缀
$phome_cookieckrnd='vtZxfBR9uAzUiu29dLRnD2v8PdNeJM';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'投资方块—量化投资理财',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'bGssANvQbh5xCQ62QBCr3BbupYMKv3',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/about/\">交易所介绍</a>&nbsp;|&nbsp;<a href=\"/yw/\">行情软件</a>&nbsp;|&nbsp;<a href=\"/case/\">典型案例</a>&nbsp;|&nbsp;<a href=\"/article/\">技术交流</a>&nbsp;|&nbsp;<a href=\"/contact/\">联系我们</a>',
'plgroupid'=>0,
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
...
'definfovoteid'=>0,
'orderf'=>'',
'sonclass'=>'|1|2|5|6|7|8|9|10|16|17|18|19|',
'tid'=>1,
'tbname'=>'news');
