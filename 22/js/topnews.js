            ...
            try
             {
                ...
                for(var i=0;i<tagTitle.length;i++)
                {
                    ...
                    var str="<li "+style+"><a href='/C/"+link+"' target=_blank title='"+tooltip+"'><span "+topcss+">"+hm+" " +"[快讯] "+title+"</span></a></li>";
...
function GetLastCallback() {
    if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
        ...
        for (var i = 0; i < latstNewsArray.length; i++) {
            ...
            var str = "<li><a href='/C/" + link + "' target=_blank title='" + tooltip + "'><span>" + hm + " " + "[快讯] " + title + "</span></a></li>";
